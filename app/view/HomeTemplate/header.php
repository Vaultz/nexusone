<header>
  <nav>
    <div class="navbar nav-wrapper indigo darken-1">
      <div class="row">
        ...
        if (isset($_SESSION["user"])) { ?>
          <a href="#"><i class="button_logout right material-icons">power_settings_new</i></a>
        <?php } ?>
      </div>
    </div>
  </nav>
  ...
  <ul id="slide-out" class="sidenav">
    ...
    <li><a class="waves-effect" href="offers"><i class="material-icons">fiber_new</i>Préparer une affaire</a></li>
    <li><a class="waves-effect" href="allcases.php"><i class="material-icons">format_list_bulleted</i>Modifier une affaire</a></li>
